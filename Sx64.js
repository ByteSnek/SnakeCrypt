var Serializer = /** @class */ (function () {
    ...
    Serializer.prototype.put = function (key, value) {
        this.encoder.set(key, value);
        this.decoder.set(value, key);
    };
    Object.defineProperty(Serializer.prototype, "getEncoder", {
        get: function () {
            return this.encoder;
        },
        enumerable: false,
    ...
    Object.defineProperty(Serializer.prototype, "getDecoder", {
        get: function () {
            return this.decoder;
        },
        enumerable: false,
...
var CodecType;
(function (CodecType) {
    CodecType[CodecType["SX10"] = 0] = "SX10";
    CodecType[CodecType["SX16"] = 1] = "SX16";
})(CodecType || (CodecType = {}));
var codec;
var serializer10 = new Serializer();
var serializer16 = new Serializer();
...
function encode() {
    ...
    if (input != null) {
        if (codec == CodecType.SX16) {
            ...
            for (var i = 0; i < input.length; i++) {
                var char = input.charAt(i);
                var encodedChar_1 = encoder10.get(char);
                buffer.push(unsafeCast(encodedChar_1 == null ? char : encodedChar_1));
            }
        }
...
function setSx10() {
    ...
    console.log("CodecType has been set to: ".concat(CodecType[codec]));
}
function setSx16() {
...
function getClassList(name) {
    var _a;
    return (_a = document.getElementById(name)) === null || _a === void 0 ? void 0 : _a.classList;
}
